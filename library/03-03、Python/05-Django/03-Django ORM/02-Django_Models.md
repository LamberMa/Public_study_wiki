...
2、在modle文件里不能动态增加（选项一成不变用Django的choice），选项固定的时候可以使用枚举，如果需要动态增加的时候可以使用外键。
...
models.CharField.(max_length=32, null=True, default='111')
models.CharField.(max_length=32, db_index=True, unique=True)
models.CharField.(max_length=32, null=True, unique_for_data=True)
